  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4">
        <div className="gradient-bg-red text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
          COMMUNITY
        </div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="w-16 h-16 rounded-xl gradient-bg-red flex items-center justify-center shadow-lg transform rotate-3">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-background/40 rounded-lg p-3 border border-brand-red/20">
            <p className="text-xs text-muted uppercase tracking-wider">Participants</p>
            <p className="text-lg font-bold gradient-text-red">
          ...
          <div className="bg-background/40 rounded-lg p-3 border border-brand-red/20">
            <p className="text-xs text-muted uppercase tracking-wider">Entry Fee</p>
            <p className="text-lg font-bold gradient-text-red">
              {lottery.entryFee} XLM
            </p>
          </div>
          <div className="bg-background/40 rounded-lg p-3 border border-brand-red/20">
            <p className="text-xs text-muted uppercase tracking-wider">Prize Pool</p>
            <p className="text-lg font-bold gradient-text-red">
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-background/60 rounded-full h-2">
            <div 
              className="gradient-bg-red h-2 rounded-full transition-all duration-500"
            ...
            !userPublicKey 
              ...
              : isWinner
                ...
                : hasJoined
                  ...
                  : isActive
                    ? 'gradient-bg-red text-white hover:shadow-lg hover:scale-105'
