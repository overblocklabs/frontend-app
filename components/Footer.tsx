    ...
    >
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <a 
              href="https://github.com/overblocklabs" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-muted hover:text-brand-red transition-colors focus:outline-none focus:ring-2 focus:ring-brand-red focus:ring-offset-2 focus:ring-offset-background rounded p-1"
              aria-label="Follow us on GitHub (opens in new tab)"
            >
